...
exports.HOLIDAY_LIST_DIR = './lib/holiday_list';
exports.TMP_DIR = './tmp';
...
// 自動実行関連
exports.AUTOPOST_CRON_TIMER = '* * * * *';  // 毎分実行
...
// 祝日関連
exports.ENABLE_HOLIDAY = true;
exports.HOLIDAY_LIST_UPDATE_CRON_TIMER = '0 0 1 * *';   // 毎月1日の00:00に実行
exports.HOLIDAY_LIST_FILE_CAO_CSV = 'syukujitsu.csv';   // 内閣府が提供する祝日一覧（文字コード：UTF-8）
exports.HOLIDAY_LIST_CSV_PROVIDER_URL = 'https://www8.cao.go.jp/chosei/shukujitsu/' + this.HOLIDAY_LIST_FILE_CAO_CSV;
exports.HOLIDAY_LIST_FILE_ORIGINAL= 'original.csv';   // 独自に定義した休日（文字コード：UTF-8）
